					  ...
					  1)
						  ...
						  case $dingshi in
							  1)
								  ...
								  ;;
							  2)
								  read -e -p "Choose a day of the week to perform the task? (0 ～ 6、0 は日曜日を表します):" weekday
							  ...
							  3)
								  ...
								  ;;
							  4)
								  read -e -p "Enter what time of the hour the task should be executed? (分、0 ～ 60):" minute
