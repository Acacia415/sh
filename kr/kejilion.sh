...
linux_tools() {
  ...
  while true; do
	  ...
	  echo -e "${gl_kjlan}15.  ${gl_bai}vim 텍스트 편집기${gl_kjlan}16.  ${gl_bai}nano 文本编辑器 ${gl_huang}★${gl_bai}"
...
while true; do
	  ...
	  case $sub_choice in
		  ...
		  5)
			  ...
			  echo -e "귀하의${gl_huang}servers.py${gl_bai} 文件到 ${gl_huang}/root/cluster/${gl_bai}복원 완료!"
			  break_end
			  ;;
